				...
				<div
										...
										<button
											...
											<span className="flex w-full justify-between items-center">
												...
												<svg
													...
													data-todo-x-description="Heroicon name: solid/selector"
													xmlns="http://www.w3.org/2000/svg"
													viewBox="0 0 20 20"
													fill="currentColor"
													aria-hidden="true">
					...
					<div className="flex flex-col w-0 flex-1 overflow-hidden">
						...
						<div className="relative z-10 flex-shrink-0 flex h-16 bg-white border-b border-gray-200 lg:hidden">
							<button
								data-todo-x-description="Sidebar toggle, controls the 'sidebarOpen' sidebar state."
								data-todo-at-click-stop="sidebarOpen = true"
								className="px-4 border-r border-gray-200 text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-purple-500 lg:hidden">
								<span className="sr-only">Open sidebar</span>
								<svg
									className="h-6 w-6"
									data-todo-x-description="Heroicon name: outline/menu-alt-1"
									xmlns="http://www.w3.org/2000/svg"
									fill="none"
									viewBox="0 0 24 24"
									stroke="currentColor"
										...
										<div className="flex-1 flex items-center justify-between border-t border-r border-b border-gray-200 bg-white rounded-r-md truncate">
											...
											<div
												...
												<button
													type="button"
													className="w-8 h-8 bg-white inline-flex items-center justify-center text-gray-400 rounded-full hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500"
													id="pinned-project-options-menu-1"
													aria-expanded="false"
													data-todo-at-click="open = !open"
													aria-haspopup="true"
													data-todo-x-bind-aria-expanded="open">
												...
												<div
													...
													role="menu"
													aria-orientation="vertical"
													aria-labelledby="pinned-project-options-menu-1">
													<div className="py-1" role="none">
														<a
															href="/"
															className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900"
										...
										<div className="flex-1 flex items-center justify-between border-t border-r border-b border-gray-200 bg-white rounded-r-md truncate">
											...
											<div
												...
												<button
													type="button"
													className="w-8 h-8 bg-white inline-flex items-center justify-center text-gray-400 rounded-full hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500"
													id="pinned-project-options-menu-2"
													aria-expanded="false"
													data-todo-at-click="open = !open"
													aria-haspopup="true"
													data-todo-x-bind-aria-expanded="open">
												...
												<div
													...
													role="menu"
													aria-orientation="vertical"
													aria-labelledby="pinned-project-options-menu-2">
													<div className="py-1" role="none">
														<a
															href="/"
															className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900"
										...
										<div className="flex-1 flex items-center justify-between border-t border-r border-b border-gray-200 bg-white rounded-r-md truncate">
											...
											<div
												...
												<button
													type="button"
													className="w-8 h-8 bg-white inline-flex items-center justify-center text-gray-400 rounded-full hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500"
													id="pinned-project-options-menu-3"
													aria-expanded="false"
													data-todo-at-click="open = !open"
													aria-haspopup="true"
													data-todo-x-bind-aria-expanded="open">
												...
												<div
													...
													role="menu"
													aria-orientation="vertical"
													aria-labelledby="pinned-project-options-menu-3">
													<div className="py-1" role="none">
														<a
															href="/"
															className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900"
								...
								<ul
									...
									<li>
										<a
											...
											<span className="flex items-center truncate space-x-3">
												<span
													className="w-2.5 h-2.5 flex-shrink-0 rounded-full bg-purple-600"
													aria-hidden="true"></span>
												<span className="font-medium truncate text-sm leading-6">
													New Benefits Plan
													{/* space */}
									...
									<li>
										<a
											...
											<span className="flex items-center truncate space-x-3">
												<span
													className="w-2.5 h-2.5 flex-shrink-0 rounded-full bg-yellow-500"
													aria-hidden="true"></span>
												<span className="font-medium truncate text-sm leading-6">
													Onboarding Emails
													{/* space */}
									...
									<li>
										<a
											...
											<span className="flex items-center truncate space-x-3">
												<span
													className="w-2.5 h-2.5 flex-shrink-0 rounded-full bg-green-500"
													aria-hidden="true"></span>
												<span className="font-medium truncate text-sm leading-6">
													iOS App
													{/* space */}
										...
										<tbody className="bg-white divide-y divide-gray-100" data-todo-x-max="1">
														...
														<div
															...
															<div className="py-1" role="none">
																<a
																	...
																	<svg
																		...
																		data-todo-x-description="Heroicon name: solid/pencil-alt"
																		xmlns="http://www.w3.org/2000/svg"
																		viewBox="0 0 20 20"
																		fill="currentColor"
																		aria-hidden="true">
																...
																<a
																	...
																	<svg
																		className="mr-3 h-5 w-5 text-gray-400 group-hover:text-gray-500"
																		data-todo-x-description="Heroicon name: solid/duplicate"
																		xmlns="http://www.w3.org/2000/svg"
																		viewBox="0 0 20 20"
																		fill="currentColor"
																		aria-hidden="true">
															...
															<div className="py-1" role="none">
																<a
																	...
																	<svg
																		className="mr-3 h-5 w-5 text-gray-400 group-hover:text-gray-500"
																		data-todo-x-description="Heroicon name: solid/trash"
																		xmlns="http://www.w3.org/2000/svg"
																		viewBox="0 0 20 20"
																		fill="currentColor"
																		aria-hidden="true">
											...
											<tr>
												<td className="px-6 py-3 max-w-0 w-full whitespace-nowrap text-sm font-medium text-gray-900">
													<div className="flex items-center space-x-3 lg:pl-2">
														<div
															className="flex-shrink-0 w-2.5 h-2.5 rounded-full bg-purple-600"
															aria-hidden="true"></div>
														<a href="/" className="truncate hover:text-gray-600">
															<span>
																New Benefits Plan
												...
												<td className="pr-6">
													<div
														...
														<div
															...
															role="menu"
															aria-orientation="vertical"
															aria-labelledby="project-options-menu-1">
															<div className="py-1" role="none">
																<a
																	href="/"
																	className="group flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900"
												...
												<td className="pr-6">
													<div
														...
														<div
															...
															role="menu"
															aria-orientation="vertical"
															aria-labelledby="project-options-menu-2">
															<div className="py-1" role="none">
																<a
																	href="/"
																	className="group flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900"
											...
											<tr>
												<td className="px-6 py-3 max-w-0 w-full whitespace-nowrap text-sm font-medium text-gray-900">
													<div className="flex items-center space-x-3 lg:pl-2">
														<div
															className="flex-shrink-0 w-2.5 h-2.5 rounded-full bg-green-500"
															aria-hidden="true"></div>
														<a href="/" className="truncate hover:text-gray-600">
															<span>
																iOS App
												...
												<td className="pr-6">
													<div
														...
														<div
															...
															role="menu"
															aria-orientation="vertical"
															aria-labelledby="project-options-menu-3">
															<div className="py-1" role="none">
																<a
																	href="/"
																	className="group flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900"
												...
												<td className="pr-6">
													<div
														...
														<div
															...
															role="menu"
															aria-orientation="vertical"
															aria-labelledby="project-options-menu-4">
															<div className="py-1" role="none">
																<a
																	href="/"
																	className="group flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900"
												...
												<td className="pr-6">
													<div
														...
														<div
															...
															role="menu"
															aria-orientation="vertical"
															aria-labelledby="project-options-menu-5">
															<div className="py-1" role="none">
																<a
																	href="/"
																	className="group flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900"
												...
												<td className="pr-6">
													<div
														...
														<div
															...
															role="menu"
															aria-orientation="vertical"
															aria-labelledby="project-options-menu-6">
															<div className="py-1" role="none">
																<a
																	href="/"
																	className="group flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900"
												...
												<td className="pr-6">
													<div
														...
														<div
															...
															role="menu"
															aria-orientation="vertical"
															aria-labelledby="project-options-menu-7">
															<div className="py-1" role="none">
																<a
																	href="/"
																	className="group flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900"
												...
												<td className="pr-6">
													<div
														...
														<div
															...
															role="menu"
															aria-orientation="vertical"
															aria-labelledby="project-options-menu-8">
															<div className="py-1" role="none">
																<a
																	href="/"
																	className="group flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900"
												...
												<td className="pr-6">
													<div
														...
														<div
															...
															role="menu"
															aria-orientation="vertical"
															aria-labelledby="project-options-menu-9">
															<div className="py-1" role="none">
																<a
																	href="/"
																	className="group flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900"
												...
												<td className="pr-6">
													<div
														...
														<div
															...
															role="menu"
															aria-orientation="vertical"
															aria-labelledby="project-options-menu-10">
															<div className="py-1" role="none">
																<a
																	href="/"
																	className="group flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900"
												...
												<td className="pr-6">
													<div
														...
														<div
															...
															role="menu"
															aria-orientation="vertical"
															aria-labelledby="project-options-menu-11">
															<div className="py-1" role="none">
																<a
																	href="/"
																	className="group flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900"
